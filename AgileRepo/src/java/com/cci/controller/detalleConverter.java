...
private final static String DELIMITER = "~";
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
       ...
       DetalleEvento detallito=new DetalleEvento(partes[0],partes[1],Integer.parseInt(partes[2]),Integer.parseInt(partes[3]),Integer.parseInt(partes[4]),Integer.parseInt(partes[5]),Integer.parseInt(partes[6]));
