...
ImageIO.write(buffer,"png",new File("C:/Users/Daniel/Documents/NetBeansProjects/agileRepo/AgileRepo/web/resources/omega-layout/images/EventosSumary", filename));
     }catch(IOException e){
         e.printStackTrace();
     }
